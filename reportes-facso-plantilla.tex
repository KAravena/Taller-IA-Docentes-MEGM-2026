...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, bottomrule=.15mm, opacityback=0, toptitle=1mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, left=2mm, arc=.35mm, colback=white, bottomtitle=1mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, leftrule=.75mm, opacitybacktitle=0.6, coltitle=black]
...
Domingo en la noche: te avisan que debes hacer un remplazo o realizar
una clasee con un curso más diverso. Debe armar una propuesta o borrador
lista para usar, eligiendo un tema que les sirva, o les gustaria
planificar (OA pendiente, habilidad clave o contenido difícil), con
evaluación formativa.

El curso tiene alta heterogeneidad: hay diversos estudiantes con
\textbf{ausencias prolongadas}, estudiantes que participan del
\textbf{PIE}, estudiantes \textbf{recién llegados al sistema escolar
chileno} y otros con \textbf{baja motivación}. Tienes \textbf{poco
tiempo}, recursos limitados y solo cuentas con una herramienta de IA
como \textbf{asistente de borradores} (no como ``juez'' ni como
reemplazo de decisiones pedagógicas).
...
Pueden \textbf{subir como referencia} pautas, guías o actividades que ya
hayan usado antes, para que la IA \textbf{genere un borrador similar en
estilo y estructura}, que luego el equipo docente revisa y ajusta.
