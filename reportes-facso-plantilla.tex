...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, toptitle=1mm, rightrule=.15mm, left=2mm, toprule=.15mm, colframe=quarto-callout-note-color-frame, arc=.35mm, titlerule=0mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, bottomrule=.15mm, opacityback=0, colback=white, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, bottomtitle=1mm, opacitybacktitle=0.6]
